...
use pet4web\Comments;
use pet4web\CommentsQuery;
...
class CommentsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'pet4web.Map.CommentsTableMap';
     ...
     */
    const OM_CLASS = '\\pet4web\\Comments';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'pet4web.Comments';
     ...
     */
    const COL_MESSAGE = 'comments.message';
     ...
     */
    const COL_PETID = 'comments.petid';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Message', 'Userid', 'Petid', ),
        self::TYPE_CAMELNAME     => array('id', 'message', 'userid', 'petid', ),
        self::TYPE_COLNAME       => array(CommentsTableMap::COL_ID, CommentsTableMap::COL_MESSAGE, CommentsTableMap::COL_USERID, CommentsTableMap::COL_PETID, ),
        self::TYPE_FIELDNAME     => array('id', 'message', 'userid', 'petid', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Message' => 1, 'Userid' => 2, 'Petid' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'message' => 1, 'userid' => 2, 'petid' => 3, ),
        self::TYPE_COLNAME       => array(CommentsTableMap::COL_ID => 0, CommentsTableMap::COL_MESSAGE => 1, CommentsTableMap::COL_USERID => 2, CommentsTableMap::COL_PETID => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'message' => 1, 'userid' => 2, 'petid' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\pet4web\\Comments');
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CommentsTableMap::COL_MESSAGE);
            $criteria->addSelectColumn(CommentsTableMap::COL_USERID);
            $criteria->addSelectColumn(CommentsTableMap::COL_PETID);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \pet4web\Comments) { // it's a model object
