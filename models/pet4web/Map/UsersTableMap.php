...
class UsersTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'pet4web.Map.UsersTableMap';
     ...
     */
    const OM_CLASS = '\\pet4web\\Users';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'pet4web.Users';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Email', 'Password', 'Type', 'Birth', 'Country', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'email', 'password', 'type', 'birth', 'country', ),
        self::TYPE_COLNAME       => array(UsersTableMap::COL_ID, UsersTableMap::COL_NAME, UsersTableMap::COL_EMAIL, UsersTableMap::COL_PASSWORD, UsersTableMap::COL_TYPE, UsersTableMap::COL_BIRTH, UsersTableMap::COL_COUNTRY, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'email', 'password', 'type', 'birth', 'country', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Email' => 2, 'Password' => 3, 'Type' => 4, 'Birth' => 5, 'Country' => 6, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'email' => 2, 'password' => 3, 'type' => 4, 'birth' => 5, 'country' => 6, ),
        self::TYPE_COLNAME       => array(UsersTableMap::COL_ID => 0, UsersTableMap::COL_NAME => 1, UsersTableMap::COL_EMAIL => 2, UsersTableMap::COL_PASSWORD => 3, UsersTableMap::COL_TYPE => 4, UsersTableMap::COL_BIRTH => 5, UsersTableMap::COL_COUNTRY => 6, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'email' => 2, 'password' => 3, 'type' => 4, 'birth' => 5, 'country' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    {
        $this->addRelation('Petitions', '\\pet4web\\Petitions', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':userid',
    1 => ':id',
  ),
), null, null, 'Petitionss', false);
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UsersTableMap::COL_BIRTH);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \pet4web\Users) { // it's a model object
